...
xml = <xml><fps>FPS:</fps><ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax><wmodeGPU>wmodeGPU:</wmodeGPU></xml>;
...
style.setStyle('wmodeGPU', { color: hex2css(colors.fps) } );
...
rectangle = new Rectangle(WIDTH - 1, 0, 1, HEIGHT - 60);
...
graphics.beginBitmapFill(graph, new Matrix(1, 0, 0, 1, 0, 60));
graphics.drawRect(0, 60, WIDTH, HEIGHT - 60);
...
xml.wmodeGPU = "wmodeGPU:" + stage.wmodeGPU;
